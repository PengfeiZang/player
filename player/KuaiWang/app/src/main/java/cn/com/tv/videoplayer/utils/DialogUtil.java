...
import cn.com.tv.videoplayer.dialog.ConfirmDialog;
...
public class DialogUtil {
     ...
     * @return
     */
    public static Dialog showConfirmDialog(boolean cancelable, final Context context, String title, String message, String negativeText, DialogInterface.OnClickListener negativeClickListener) {
        ConfirmDialog.Builder builder = new ConfirmDialog.Builder(context);
        builder
                .setTitle(title)
                .setMessage(Html.fromHtml(message).toString())
