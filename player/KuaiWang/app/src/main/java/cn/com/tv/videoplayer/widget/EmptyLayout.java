package cn.com.tv.videoplayer.widget;
...
import cn.com.tv.videoplayer.utils.TDevice;
...
public class EmptyLayout extends LinearLayout implements
    ...
    private void init() {
        ...
        mLayout = (AutoRelativeLayout) view.findViewById(R.id.pageerrLayout);
    ...
    public void setErrorType(int errorType) {
        ...
        switch (errorType) {
            case NETWORK_ERROR:
                ...
                img.setBackgroundResource(R.drawable.notice);
