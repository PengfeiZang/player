...
/**
 * Created by ${ZangPengfei} on 2017/11/13.
 */
    ...
    public void setOrChangeTranslucentColor(Toolbar toolbar, View bottomNavigationBar, int translucentPrimaryColor) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT
            ...
            if (toolbar != null) {
                ...
                //设置顶部的颜色
                toolbar.setBackgroundColor(getResources().getColor(translucentPrimaryColor));
            }
            if (bottomNavigationBar != null) {
                ...
                if (hasNavigationBarShow(getWindowManager())) {
                    ...
                    //设置底部导航栏的颜色
                    bottomNavigationBar.setBackgroundColor(getResources().getColor(translucentPrimaryColor));
                }
            }
        } else if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setNavigationBarColor(getResources().getColor(translucentPrimaryColor));
            getWindow().setStatusBarColor(getResources().getColor(translucentPrimaryColor));
        } else {
            //<4.4的，不做处理
        }
    }
